  ...
  <div class="popup" @click="emits('exit')">
    <div class="popup-wrap" @click="(e) => e.stopPropagation()">
      <div class="popup-header">
        <div>
          <span>"{{ state.search.keyword }}"</span>로 검색된 파일 내역 (총
          {{ count }}건)
        </div>
        <svg
          @click="emits('exit')"
          ...
          >
            <div class="img">
              ...
              >
                ...
                />
                <path
                  d="M0.5 3.3286C0.5 2.83006 0.867198 2.40768 1.36089 2.33832L14.1976 0.535022C14.7994 0.450495 15.3368 0.917688 15.3368 1.5253V22.36C15.3368 22.9676 14.7994 23.4348 14.1976 23.3503L1.36089 21.547C0.867198 21.4776 0.5 21.0552 0.5 20.5567V3.3286Z"
                  fill="#13A650"
                />
                <mask
                  id="mask0_1043_15054"
                ...
                >
                  <path
                    d="M4.05469 9.83581C4.05469 9.30237 4.47339 8.86285 5.0062 8.83698L9.00856 8.64269C9.57921 8.61499 10.057 9.07019 10.057 9.64152V14.2437C10.057 14.8151 9.57921 15.2703 9.00856 15.2426L5.0062 15.0483C4.47339 15.0224 4.05469 14.5829 4.05469 14.0494V9.83581Z"
                    fill="#D9D9D9"
                  />
                </mask>
                <g mask="url(#mask0_1043_15054)">
                  <path
                    d="M5.64041 8.67334L7.01039 10.922H7.05667L8.4359 8.67334H10.0095L7.96381 11.9425L10.0558 15.2116H8.44516L7.05667 12.9629H7.01039L5.6219 15.2116H4.02051L6.12175 11.9425L4.05753 8.67334H5.64041Z"
                    fill="white"
                  />
                </g>
              </svg>
...
const init = async () => {
  const { data } = await axios.get(
    `/search?q=${state.search.keyword}&folderCd=${state.search.folderCd}`
  );
