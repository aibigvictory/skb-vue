    ...
    >
      ...
      >
        <div class="d-flex align-items-center position-relative my-1 ps-7">
          ...
          <input v-model="state.search.keyword" id="hedaer-input-search" @keypress="enter" type="text" data-kt-subscription-table-filter="search" class="input-search" placeholder="통합검색">
        </div>
